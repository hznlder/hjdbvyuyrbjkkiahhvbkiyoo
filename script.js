...
class CodeForge {
    ...
    populateCodeCard(card, code) {
        ...
        if (voteSection) {
            ...
            const likeBtn = voteSection.querySelector('.like-btn .vote-count');
            const dislikeBtn = voteSection.querySelector('.dislike-btn .vote-count');
            
            if (likeBtn) likeBtn.textContent = votes.likes;
            if (dislikeBtn) dislikeBtn.textContent = votes.dislikes;
        }
    }
